...
public class TestCar extends Car {
    public static void main(String[] args) {
        ...
        double maneF = Double.parseDouble(scanner.nextLine());
        ...
        car.setMane(productСardinals(car.getFullTank(), maneF));
        System.out.println("долить до полного бака "+ car.getFullTank() +" л на сумму "+car.getMane());
        ...
        car.setFullTank(minus(car.getFuelTank(),car.getResidualTank()));
        car.setMane(productСardinals(car.getFullTank(), maneF));
        System.out.println("долить топлива "+car.getFullTank() +" л на сумму "+car.getMane()+"грн.");
        ...
        car.setMane(productСardinals(fuel,maneF));
        System.out.println("-------------------------------------------------------");
        System.out.println("Одесса-Киев "+ drive +"км.");
        System.out.println("израсходовали топлива "+fuel+"л. на сумму "+car.getMane()+"грн.");
    }
